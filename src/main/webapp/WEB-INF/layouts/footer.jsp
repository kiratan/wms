		...
		<nav  class="navbar navbar-default navbar-fixed-top" role="navigation" >
			<div class="container" >	<!-- 导航条居中 -->
				  ...
				  <div class="navbar-header active">
							...
							<a  class="navbar-brand active"  href="${ctx}/menu/list">测试中呢 哈哈哈哈哈</a>
				  </div>
						      ...
						      <li class="dropdown">
						        ...
						        <ul class="dropdown-menu">
								        <shiro:guest>
								         ...
								         <shiro:authenticated>
								          <li class="center"><a href="${ctx}/user/info"><img class="img-thumbnail" src="${ctx}/resources/img/${sessionScope.LOGINED.headImg}"/></a></li>
								          <li class="small"><a href="#">尊敬的${sessionScope.LOGINED.nickName}</a></li>
								           <li class="small"><a href="#">IP:${sessionScope.LOGINED.ip}</a></li>
								          <li class="divider"></li>
								          <li class="small"><a href="${ctx}/menu/exit"><span class="glyphicon glyphicon-off"></span>   退出 </a></li>
								        </shiro:authenticated>
						        </ul>
						      </li>
					    </ul>
								    ...
								    <ul class="nav navbar-nav navbar-right">
									      <li class="dropdown">
									        ...
									        <span class="glyphicon glyphicon-envelope"></span>消息
									         <span class="badge">${msg.size()}</span>
									        </a>
									        <ul class="dropdown-menu">
