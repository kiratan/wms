  ...
  <div class="panel-body">
		<div class="row ">
			<div class="alert alert-warning alert-dismissable" id="alert" >
			  <strong>警告：</strong>
			  <span id="warn">
			  本功能只对河南移动用户有用，本功能只做技术交流使用，所有责任由使用者承担。
			  </span>
			  <div id="warn">
			  </div>
		</div>
		...
		<div class="input-group">
			...
			<span class="input-group-addon alert-info">只能轰炸河南移动号码。。。。 </span>
			</div>
			<br />
			<div class="input-group">
		...
		<span class="input-group-addon alert-info">10分钟内只能轰炸一次最多50条</span>
		</div>
		<br/>
		<div class="row">
